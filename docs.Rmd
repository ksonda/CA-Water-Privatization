...
mapview(bkfield,zcol="median_income",layer.name="Census Block Group - Median HH Income") + mapview(d.b, alpha=1, layer.name = "Water System Boundaries", stroke=TRUE,color="black",col.regions="black", alpha.regions=0, lwd=4)
