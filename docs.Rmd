...
mapview(d.b,zcol="Water System Ownership", alpha=0.8, layer.name = "Water System Boundaries") +
  mapview(pl, stroke=TRUE,zcol="NAME", color="red", alpha.regions=0, layer.name = "Municipal Boundaries",lwd=2)
...
bk.bound <- d.b[st_bbox(bkfield),]
m2<-mapview(bkfield,zcol="median_income",layer.name="Census Block Group - Median HH Income") + mapview(bk.bound, alpha=1, layer.name = "Water System Boundaries", stroke=TRUE,color="black",col.regions="black", alpha.regions=0, lwd=4)
